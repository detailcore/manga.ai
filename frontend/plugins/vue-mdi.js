...
import BookmarkMultiple from 'vue-material-design-icons/BookmarkMultiple.vue';
...
export default function materialIcons() {
  ...
  Vue.component('MdiBookshelf', Bookshelf);
  Vue.component('MdiThemeLightDark', ThemeLightDark);
  Vue.component('MdiBookmarkMultiple', BookmarkMultiple);
  ...
  Vue.component('MdiMenuUp', MenuUp);
  ...
  Vue.component('MdiBookmark', Bookmark);
  Vue.component('MdiImageText', ImageText);
  Vue.component('MdiImage', Image);
  Vue.component('MdiImageOff', ImageOff);
  ...
  Vue.component('MdiSortNumericDescending', SortNumericDescending);
  Vue.component('MdiReply', Reply);
  Vue.component('MdiThumbUp', ThumbUp);
  ...
  // Vue.component('MdiDominoMask', DominoMask);
  // Vue.component('MdiChevronUp', ChevronUp);
  // Vue.component('MdiChevronDown', ChevronDown);
}